    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a class="btn btn-primary radius" data-title="添加客户" href="/customer-add.html"
                   onclick="article_add('添加客户','/customer-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加客户</a>
				</span>
                        ...
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                ...
                                <a class="btn btn-primary radius" data-title="删除"
                                   href="/sys/delCustomer?orderId=${customer.id}"
                                   onclick="article_add('退货','/sys/delCustomer?orderId=${customer.id}')"
                                   href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
