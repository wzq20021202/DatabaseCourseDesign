            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A">${user.name}
                    ...
                    <c:forEach items="${orderList}" var="purchaseOrder">
                        <tr class="text-c">
                            ...
                            <td class="text-l"><u style="cursor:pointer" class="text-primary"
                                                  ...
                                                  title="查看">${purchaseOrder.id}</u></td>
                            ...
                            <td class="td-status"><span
                                    class="label label-success radius">${purchaseOrder.total/10000}万</span></td>

                            <td class="td-status"><span class="label label-success radius">${purchaseOrder.flag}</span>
                            </td>
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5"
                                   onClick="article_edit('编辑','article-add.html','10001')" href="javascript:;"
                                   title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a class="btn btn-primary radius" data-title="入库"
                                   href="/purchase/addstock?orderId=${purchaseOrder.id}"
                                   onclick="article_add('入库','/purchase/addstock?orderId=${purchaseOrder.id}')"
                                   href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 入库</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
