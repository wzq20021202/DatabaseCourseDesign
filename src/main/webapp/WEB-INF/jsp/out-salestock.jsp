...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><span class="logo navbar-logo f-l mr-10 hidden-xs">
            <a href="/sys/gotoIndex" class="logo navbar-logo f-l mr-10 hidden-xs">仓库管理系统</a></span>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加商品" href="/article-add.html"
                   onclick="article_add('添加商品','/article-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a>
				<a class="btn btn-primary radius" data-title="添加订单" href="/purchase/sub"
                   onclick="article_add('添加订单','/purchase/sub')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a>
				</span>
                    ...
                    <c:forEach items="${saleorderList}" var="saleOrder">
                        <tr class="text-c">
                            ...
                            <td class="text-l"><u style="cursor:pointer" class="text-primary"
                                                  ...
                                                  title="查看">${saleOrder.id}</u></td>
                            <td>${saleOrder.customerId}</td>
                            <td>${saleOrder.pay}</td>
                            <td>${saleOrder.saleDate}</td>
                            <td class="td-status"><span class="label label-success radius">${saleOrder.total}</span>
                            </td>
                            <td class="td-status"><span class="label label-success radius">${saleOrder.flag}</span></td>
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5"
                                   onClick="article_edit('编辑','article-add.html','10001')" href="javascript:;"
                                   title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a class="btn btn-primary radius" data-title="发货"
                                   href="/sale/outstock?orderId=${saleOrder.id}"
                                   onclick="article_add('发货','/sale/outstock?orderId=${saleOrder.id}')"
                                   href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 发货</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
